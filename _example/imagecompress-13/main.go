...
func main() {
	var benchmark bool
	var bitrate int
	flag.BoolVar(&benchmark, "benchmark", false, "run benchmark")
	flag.IntVar(&bitrate, "bitrate", 200, "target bitrate in kbps")
	flag.Parse()
	...
	maxbit := bitrate * 1000 // Target total bits (approx)
